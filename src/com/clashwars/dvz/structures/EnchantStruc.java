...
public class EnchantStruc extends Structure {
    ...
    private void populateEnchants() {
        //Bow
        enchants.add(new CustomEnchant(Enchantment.ARROW_DAMAGE, "Power 1", 1, 100, new Material[] {Material.BOW}));
        enchants.add(new CustomEnchant(Enchantment.ARROW_DAMAGE, "Power 2", 2, 200, new Material[] {Material.BOW}));
        enchants.add(new CustomEnchant(Enchantment.ARROW_KNOCKBACK, "Punch 1", 1, 100, new Material[] {Material.BOW}));
        ...
        enchants.add(new CustomEnchant(Enchantment.DURABILITY, "Block 2 (custom)", 2, 300, new Material[] {Material.DIAMOND_SWORD}));
        ...
        enchants.add(new CustomEnchant(Enchantment.DAMAGE_ALL, "Sharpness 1", 1, 200, new Material[] {Material.GOLD_SWORD}));
