...
public enum StatType {
    ...
    GENERAL_TOTAL_DEATHS(5), //Calculated
    GENERAL_TIMES_TELEPORTED(6),
    GENERAL_TIMES_SWITCHED(7),
    GENERAL_ARROWS_SHOT(8),
    GENERAL_ARROWS_HIT(9),
    GENERAL_BOW_ACCURACY(10), //Calculated
    GENERAL_CHAT_MESSAGES(11),
    GENERAL_TIMES_COMPLETED_PARKOUR(12),
    GENERAL_TOTAL_KILLS(25), //Calculated
    GENERAL_KDR(26), //Calculated
    GENERAL_GAME_TIME(78),

    DWARF_DEATHS(3),
    DWARF_MONSTER_KILLS(13), //NOT ADDED
    DWARF_DRAGON_KILLS(14), //NOT ADDED
    DWARF_DRAGON_DAMAGE(15), //NOT ADDED
    DWARF_DAMAGE_DEALT(16), //NOT ADDED
    DWARF_DAMAGE_TAKEN(17), //NOT ADDED
    ...
    MONSTER_DEATHS(4),
    MONSTER_DWARF_KILLS(27), //NOT ADDED
